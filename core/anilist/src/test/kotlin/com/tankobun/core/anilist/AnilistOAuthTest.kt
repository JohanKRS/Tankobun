...
class AnilistOAuthTest {
    ...
    fun authorizationUrlUsesAniListImplicitGrantParameters() {
        ...
        assertEquals(
            "https://anilist.co/api/v2/oauth/authorize?client_id=40942&response_type=token",
            url,
        )
    }
    ...
    fun parsesImplicitGrantFragment() {
        val token = AnilistOAuth.parseRedirect(
            "tankobun://auth/anilist#access_token=abc123&token_type=Bearer&expires_in=31536000",
        )
