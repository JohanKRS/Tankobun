...
fun tankobunThemeChoices(): List<TankobunThemeChoice> = listOf(
    ...
    TankobunThemeChoice(
        ...
        name = "Sakura Mint",
        description = "Petal pink with fresh green notes",
        dark = false,
        swatches = listOf(Color(0xFFFFF6FA), Color(0xFFC95F88), Color(0xFF51A28E)),
    ),
    TankobunThemeChoice(
        mode = TankobunThemeMode.CLOUDBERRY_POP,
        name = "Cloudberry Pop",
        description = "Airy blue with berry-bright accents",
        dark = false,
        swatches = listOf(Color(0xFFF2F8FF), Color(0xFF4169B2), Color(0xFFE55B7E)),
    ),
    TankobunThemeChoice(
...
private fun themeSpecFor(mode: TankobunThemeMode): TankobunThemeSpec = when (mode) {
    ...
    TankobunThemeMode.SAKURA_MINT -> TankobunThemeSpec(
        colors = lightColorScheme(
            primary = Color(0xFFC95F88),
            onPrimary = Color.White,
            secondary = Color(0xFF51A28E),
            onSecondary = Color.White,
            tertiary = Color(0xFF5E69B2),
            onTertiary = Color.White,
            background = Color(0xFFFFF6FA),
            onBackground = Color(0xFF26151C),
            surface = Color(0xFFFFFFFF),
            onSurface = Color(0xFF26151C),
            surfaceVariant = Color(0xFFFFDCE8),
            ...
            onSecondaryContainer = Color(0xFF07352E),
        ),
        tokens = TankobunThemeTokens(
            appBackdrop = Color(0xFFFFF6FA),
            elevatedSurface = Color(0xFFFFFFFF),
            softAccent = Color(0xFFFFE5EF),
            readerOverlay = Color(0xCC090608),
            drawerHandle = Color(0x33C95F88),
            coverScrim = Color(0x22000000),
        ),
    )
    TankobunThemeMode.CLOUDBERRY_POP -> TankobunThemeSpec(
        colors = lightColorScheme(
            primary = Color(0xFF4169B2),
            onPrimary = Color.White,
            secondary = Color(0xFFE55B7E),
            onSecondary = Color.White,
            tertiary = Color(0xFF39A7A0),
            onTertiary = Color.White,
            background = Color(0xFFF2F8FF),
            onBackground = Color(0xFF111B2B),
            surface = Color(0xFFFFFFFF),
            onSurface = Color(0xFF111B2B),
            surfaceVariant = Color(0xFFDDE8FB),
        ...
        tokens = TankobunThemeTokens(
            appBackdrop = Color(0xFFF2F8FF),
            elevatedSurface = Color(0xFFFFFFFF),
            softAccent = Color(0xFFE4EEFF),
            readerOverlay = Color(0xCC03070D),
            drawerHandle = Color(0x334169B2),
            coverScrim = Color(0x22000000),
        ),
    )
    TankobunThemeMode.YUZU_GARDEN -> TankobunThemeSpec(
        colors = lightColorScheme(
            primary = Color(0xFF1F8F87),
            onPrimary = Color.White,
            secondary = Color(0xFFE0A800),
            onSecondary = Color(0xFF332500),
            tertiary = Color(0xFF668B2B),
            onTertiary = Color.White,
            background = Color(0xFFFBFDEB),
            onBackground = Color(0xFF171E12),
            surface = Color(0xFFFFFFFF),
            onSurface = Color(0xFF171E12),
            surfaceVariant = Color(0xFFE7EDC8),
            onSurfaceVariant = Color(0xFF465038),
            primaryContainer = Color(0xFFC9F1EC),
            onPrimaryContainer = Color(0xFF003B36),
            secondaryContainer = Color(0xFFFFED9F),
            onSecondaryContainer = Color(0xFF332500),
        ),
        tokens = TankobunThemeTokens(
            appBackdrop = Color(0xFFFBFDEB),
            elevatedSurface = Color(0xFFFFFFFF),
            softAccent = Color(0xFFEFF5D2),
